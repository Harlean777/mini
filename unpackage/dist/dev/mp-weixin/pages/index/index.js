...
var _navigate = _interopRequireDefault(__webpack_require__(/*! @/utils/navigate.js */ 29));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var _default = { data: function data() {return { title: 'Hello', activeCap: '焦点新闻' //选中的cap文案
    };}, onLoad: function onLoad() {uni.hideTabBar(); //隐藏掉默认配置的这样尽可以显示自定义的tabbar,可以解决左上角小房子（回到首页）问题
  }, onReachBottom: function onReachBottom() {console.log("111111111");}, methods: { selectCap: function selectCap(text) {this.activeCap = text;}, //查看详情
    showDetail: function showDetail() {_navigate.default.navigateTo({ url: '/pages/index/detail' });} } };exports.default = _default;
